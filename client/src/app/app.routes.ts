...
import { CheckoutSuccessComponent } from './features/checkout/checkout-success/checkout-success';
...
export const routes: Routes = [
    ...
    {path:"checkout/success", component:CheckoutSuccessComponent, canActivate:[authGuard, emptyCartGuard]},
